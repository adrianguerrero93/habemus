...
// In-memory mock repository for iOS (no database)
private class MockProductRepository : ProductRepository {
    // Hardcoded Baum beer products
...
// iOS entry point - creates ViewModel and calls App()
@Composable
fun AppWithViewModel() {
    val viewModel = remember {
        SalesViewModel(MockProductRepository())
    }
    App(viewModel)
}
